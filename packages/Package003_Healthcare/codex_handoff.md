# Codex Handoff — Package003_Healthcare v1.0.0
...
4 CSV datasets (146 rows total) covering Medical Regulatory Bodies & Health Missions, Medical
...
4. This package's confidence scores (78-88) were capped by an environment constraint (WebFetch to
...
- Do not infer/backfill missing fields (bed capacity, contact numbers, MBBS seat counts, lat/long,
  ICU/dialysis/ambulance availability, etc.) — they were deliberately left out of scope for RC1/RC2
...
- Do not merge this package to `main` or otherwise treat it as canonical — it is RC2, explicitly

...
export default function HomeDiscoverSection() {
  ...
  const DISCOVER_CARDS = [
    ...
    { emoji: "???", label: t("archetype.builder", "Builder"), desc: t("archetype.builder_desc", "Operations & Delivery Lead — makes things actually run."), bg: "bg-amber-50", border: "border-amber-200" },

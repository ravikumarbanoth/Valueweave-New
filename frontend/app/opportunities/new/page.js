...
// useSearchParams() opts this subtree into client-side rendering. In the Next.js
// 14 App Router, any component reading it must sit inside a <Suspense> boundary
// or the static prerender at build time fails. We wrap the real form below.
...
// Lightweight fallback shown during prerender / while the client resolves
// search params. Mirrors the page chrome so there's no layout shift.
